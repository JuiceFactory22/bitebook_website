...
export const restaurants: Restaurant[] = [
  { name: 'Orange Ale House', image: '/images/Logos/New Haven/orange-ale-house-grille.jpeg' },
  { name: 'Pizza at the Brick Oven', image: '/images/Logos/New Haven/pizza-at-the-brick-oven-logo.jpeg' }, // Missing - will show fallback
  { name: 'Hop Haus Craft Eatery', image: '/images/Logos/New Haven/hop-haus-taproom.jpeg' },
  { name: 'Heffer', image: '/images/Logos/New Haven/heffer-logo.jpeg' },
  { name: 'Giulios Apizza', image: '/images/Logos/New Haven/Giulios-pizza-top-shelf-lounge.jpeg' },
  ...
  { name: "Jack's Bar & Steakhouse", image: '/images/Logos/New Haven/jack-bar-steakhouse.jpeg' },
