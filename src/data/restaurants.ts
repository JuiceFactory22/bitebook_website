...
export const restaurants: Restaurant[] = [
  { name: 'Orange Ale House', image: '/images/Logos/New Haven/orange-ale-house-logo.jpeg' }, // Missing - will show fallback
  { name: 'Pizza at the Brick Oven', image: '/images/Logos/New Haven/pizza-at-the-brick-oven-logo.jpeg' }, // Missing - will show fallback
  { name: 'Hop Haus Craft Eatery', image: '/images/Logos/New Haven/hop-haus-craft-eatery-logo.jpeg' }, // Missing - will show fallback
  { name: 'Heffer', image: '/images/Logos/New Haven/heffer-logo.jpeg' },
  { name: 'Giulios Apizza', image: '/images/Logos/New Haven/Giulios-pizza-top-shelf-lounge.jpeg' }, // Using alternative file
  ...
  { name: 'Naked Wings', image: '/images/Logos/New Haven/naked-wings-logo.jpeg' }, // Missing - will show fallback
  { name: "Ricky D's Rib Shack", image: '/images/Logos/New Haven/Ricky Ds logo.jpeg' },
  { name: "Jack's Bar & Steakhouse", image: '/images/Logos/New Haven/jacks-bar-steakhouse-logo.jpeg' }, // Missing - will show fallback
  { name: 'Southern Wings Express', image: '/images/Logos/New Haven/southern-wings-express-logo.jpeg' }, // Missing - will show fallback
