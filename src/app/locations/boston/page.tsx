...
export default function BostonPage() {
  ...
  useEffect(() => {
    trackViewContent('BiteBook Boston', pricing.regularPrice);
    trackPageView('Boston Location', 'location', pricing.regularPrice);
  ...
  useScrollTracking();
  usePageTimeTracking('Boston Location');
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 mb-8 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              <span className="text-sm font-medium text-amber-700">Boston&apos;s Restaurant Savings App</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">Boston, MA</p>
            </div>
